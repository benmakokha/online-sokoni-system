...
<!-- Block  of code for editing category --> 

<form class="form-horizontal row-fluid" name="edit-category" method="post" >
<div class="control-group">
<label class="control-label" for="category">Category</label>
<div class="controls">
<input type="text"    name="category"  placeholder="Enter Product Category" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="id"  placeholder="Enter Product Id" class="span8 tip" required>
</div>
</div>
