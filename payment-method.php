...
header('location:login.php');
	...
	if (isset($_POST['submit'])) {
		...
		if($_POST['paymethod'] == "Paypal"){	
		mysqli_query($con,"update orders set 	paymentMethod= 'incomplete' where userId='".$_SESSION['id']."' and paymentMethod is null ");
		unset($_SESSION['cart']);
		header('location:paypal-interface.php');
...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	   ...
	   <!-- <input type="radio" name="paymethod" value="COD" checked="checked"> COD -->
		...
		<input type="radio" name="paymethod" value="Cash on delivery"> Cash On Delivery <br /><br />
